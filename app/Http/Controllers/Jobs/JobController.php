...
// Check if it's the first day of the month
        if ($dayOfMonth === '1') {
            try {
                ...
                $sql = <<<SQL
                INSERT INTO transactions(client_id, type, amount, description, date, reference)
                VALUES 
                    ('PVA016', 'debit', 8000, 'Monthly Rent', '$m', 'PVA01618200'),
                    ('PVA017', 'debit', 15000, 'Monthly Rent', '$m', 'PVA01718200'),
                    ('PVA018', 'debit', 8000, 'Monthly Rent', '$m', 'PVA01818200'),
                    ('PVA019', 'debit', 10000, 'Monthly Rent', '$m', 'PVA01918200'),
                    ('PVA020', 'debit', 10000, 'Monthly Rent', '$m', 'PVA02018200'),
                    ('PVA021', 'debit', 15000, 'Monthly Rent', '$m', 'PVA02118200'),
                    ('PVA022', 'debit', 7000, 'Monthly Rent', '$m', 'PVA02218200'),
                    ('PVA023', 'debit', 10000, 'Monthly Rent', '$m', 'PVA02318200'),
                    ('PVA024', 'debit', 10000, 'Monthly Rent', '$m', 'PVA02418200'),
                    ('PVA025', 'debit', 15000, 'Monthly Rent', '$m', 'PVA02518200'),
                    ('PVA026', 'debit', 7000, 'Monthly Rent', '$m', 'PVA02618200'),
                    ('PVA027', 'debit', 10000, 'Monthly Rent', '$m', 'PVA02718200'),
                    ('PVA028', 'debit', 10000, 'Monthly Rent', '$m', 'PVA02818200'),
                    ('PVA029', 'debit', 15000, 'Monthly Rent', '$m', 'PVA02918200'),
                    ('PVA030', 'debit', 7000, 'Monthly Rent', '$m', 'PVA03018200'),
                    ('PVA031', 'debit', 10000, 'Monthly Rent', '$m', 'PVA03118200'),
                    ('PVA032', 'debit', 10000, 'Monthly Rent', '$m', 'PVA03218200'),
                    ('PVA033', 'debit', 15000, 'Monthly Rent', '$m', 'PVA03318200'),
                    ('PVA039', 'debit', 8000, 'Monthly Rent', '$m', 'PVA03918200'),
                    ('PVA034', 'debit', 4000, 'Monthly Rent', '$m', 'PVA03418200'),
                    ('PVA035', 'debit', 13000, 'Monthly Rent', '$m', 'PVA03518200'),
                    ('PVA040', 'debit', 17000, 'Monthly Rent', '$m', 'PVA04018200'),
                    ('PVA036', 'debit', 17000, 'Monthly Rent', '$m', 'PVA03618200'),
                    ('PVA001', 'debit', 13000, 'Monthly Rent', '$m', 'PVA00118200'),
                    ('PVA002', 'debit', 9000, 'Monthly Rent', '$m', 'PVA00218200'),
                    ('PVA003', 'debit', 15000, 'Monthly Rent', '$m', 'PVA00318200'),
                    ('PVA004', 'debit', 16000, 'Monthly Rent', '$m', 'PVA00418200'),
                    ('PVA005', 'debit', 10000, 'Monthly Rent', '$m', 'PVA00518200'),
                    ('PVA006', 'debit', 9000, 'Monthly Rent', '$m', 'PVA00618200'),
                    ('PVA007', 'debit', 15000, 'Monthly Rent', '$m', 'PVA00718200'),
                    ('PVA008', 'debit', 16000, 'Monthly Rent', '$m', 'PVA00818200'),
                    ('PVA009', 'debit', 10000, 'Monthly Rent', '$m', 'PVA00918200'),
                    ('PVA010', 'debit', 9000, 'Monthly Rent', '$m', 'PVA01018200'),
                    ('PVA011', 'debit', 15000, 'Monthly Rent', '$m', 'PVA01118200'),
                    ('PVA012', 'debit', 16000, 'Monthly Rent', '$m', 'PVA01218200'),
                    ('PVA013', 'debit', 10000, 'Monthly Rent', '$m', 'PVA01318200'),
                    ('PVA014', 'debit', 9000, 'Monthly Rent', '$m', 'PVA01418200'),
                    ('PVA015', 'debit', 15000, 'Monthly Rent', '$m', 'PVA01518200');
               SQL;
                DB::statement($sql);
                DB::table('jobs')->insert([
                    'job_name' => 'Monthly Rent Debit',
                    'date' => date('Y-m-d H:i:s'),
                    'status' => 'success'
                ]);
                echo 'This is an informational message.';
                Log::info('Transactions inserted successfully!');
            } catch (\Exception $e) {
                DB::table('jobs')->insert([
                    'job_name' => 'Monthly Rent Debit',
                    'date' => date('Y-m-d H:i:s'),
            ...
            echo 'Its not first day of the month';
        }
    }

    function runBills() {
        try {
            DB::statement('CALL generateBills()');
            DB::table('jobs')->insert([
                'job_name' => 'Bills Generator',
                'date' => date('Y-m-d H:i:s'),
                'status' => 'success'
            ]);
            echo 'Bills successfully generated';
            Log::info('Transactions inserted successfully!');
        } catch (\Exception $e) {
            DB::table('jobs')->insert([
                'job_name' => 'Bills Generator',
