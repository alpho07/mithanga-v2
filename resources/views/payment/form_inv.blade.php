<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group {{ $errors->has('supplier') ? 'has-error' : '' }}">
            <table class="table table-bordered">
                ...
                <tbody id="PRIMEBODY">
                    <tr id="PRIMARY">
                        <td>
                            <select name="cost_center[]" id="cost_center" class="cost_center" class="form-control" required>
                        ...
                        <td>
                            <input type="text" name="amount_invoiced[]" required placeholder="Amount Invoiced" class="form-control"/>
        ...
        <div class="form-group">
            ...
            <input type="text" name="reference" readonly="" class="form-control" value="{{date('YmdHis')}}"/>
        </div>
